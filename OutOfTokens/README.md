...
| **[docs/actor-vs-traditional-comparison.md](docs/actor-vs-traditional-comparison.md)** | Actor model vs traditional OOP (`Floor2Plan.Connectors.P6.Traditional`) |
...
OutOfTokens/
  ...
  Floor2Plan.Connectors.P6/             ← P6 connector (actor model)
  Floor2Plan.Connectors.P6.Traditional/   ← same connector, traditional OOP
