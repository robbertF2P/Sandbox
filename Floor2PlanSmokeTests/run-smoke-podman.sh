...
Environment variables such as TARGET_URL, TARGET_URLS, SMOKE_MIN_HOME_TILES,
SMOKE_HOME_TILE_SELECTOR, SMOKE_VISUAL_SETTLE_MS, CYPRESS_VIEWPORT_WIDTH, and
CYPRESS_VIEWPORT_HEIGHT are forwarded when set.
EOF
}
