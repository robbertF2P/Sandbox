...
const defaultTargetUrl = 'https://release-candidate.floor2plan.com/Account/Login';
...
module.exports = defineConfig({
  ...
  env: {
    ...
    additionalConfigColumnField: process.env.SMOKE_ADDITIONAL_CONFIG_COLUMN_FIELD || 'additionalConfig',
    additionalConfigColumnTitle: process.env.SMOKE_ADDITIONAL_CONFIG_COLUMN_TITLE || 'additional\\s*config',
