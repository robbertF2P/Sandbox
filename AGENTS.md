...
- **Object mapping:** avoid AutoMapper in new modules; explicit mapping preferred. AutoMapper only for simple profiles with unit tests calling `AssertConfigurationIsValid()` — see `module-composition-di.md` and `docs/coding-standards/csharp-coding-standards.md`.
